...
- `install/dwarven-forge.user.js` — mały loader CSS, wersja 0.7.2.
...
Jeżeli przeglądarka zachowa starszy CSS, zaktualizuj userscript do 0.7.2 i wykonaj twarde odświeżenie strony.
