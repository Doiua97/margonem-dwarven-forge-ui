...
(() => {
  // Run after the document stylesheet links so native CSS cannot replace the skin.
  ...
  link.id = ID;
  link.rel = "stylesheet";
  link.href = "https://cdn.jsdelivr.net/gh/Doiua97/margonem-dwarven-forge-ui@main/css/dwarven-forge.css?v=0.5.0";
